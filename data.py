...
class Select_Data:
    def __init__(self):
        ...
        self.稅率 = self.平均稅率
        self.十倍估價 = self.預估稅前純益 * self.稅率 * self.近一季每股盈餘 / self.近一季稅後淨利 * 4 * 10
        self.十五倍估價 = self.預估稅前純益 * self.稅率 * self.近一季每股盈餘 / self.近一季稅後淨利 * 4 * 15
        self.二十倍估價 = self.預估稅前純益 * self.稅率 * self.近一季每股盈餘 / self.近一季稅後淨利 * 4 * 20
